    ...
    <div id="kt_aside_menu_wrapper" class="w-100 hover-scroll-overlay-y scroll-ps d-flex" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="0">
        <div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-icon-gray-400 menu-arrow-gray-400 fw-bold fs-6" data-kt-menu="true">
            <div class="menu-item py-3">
                <a class="menu-link {{ Nav::isRoute('manage.dashboard') }}" href="{{ route('manage.dashboard') }}" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
                <span class="menu-link {{ Nav::isResource('user') }}{{ Nav::isResource('permission') }}{{ Nav::isResource('role') }}" title="ข้อมูลผู้ใช้" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon">
                ...
                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                    <div class="menu-item">
                        <div class="menu-content">
                            <span class="menu-section fs-5 fw-bolder ps-1 py-1">ข้อมูลผู้ใช้</span>
                        </div>
                    </div>
                    <div class="menu-item">
                        <a class="menu-link {{ Nav::isRoute('user.index') }}" href="{{ route('user.index') }}" title="แสดงข้อมูลผู้ใช้ในระบบ" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon">
                            ...
                            <span class="menu-title">รายการ</span>
                        </a>
                    </div>

                    <div class="menu-item">
                        <a class="menu-link {{ Nav::isRoute('permission.index') }}" href="{{ route('permission.index') }}" title="แสดงข้อมูลสิทธิการใช้งานในระบบ" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon">
                            ...
                            <span class="menu-title">สิทธิการใช้งาน</span>
                        </a>
                    </div>

                    <div class="menu-item">
                        <a class="menu-link {{ Nav::isRoute('role.index') }}" href="{{ route('role.index') }}" title="แสดงข้อมูลบทบาทหน้าที่" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <span class="menu-title">บทบาทหน้าที่</span>
                        </a>
                    </div>
                </div>
            </div>
